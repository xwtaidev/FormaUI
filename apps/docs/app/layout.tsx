...
const navSections: Array<{ title: string; links: Array<{ href: string; label: string }> }> = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/components/time-picker", label: "time-picker" },
      ...
      { href: "/components/transfer", label: "transfer" },
      { href: "/components/tree", label: "tree" },
      { href: "/components/tree-select", label: "tree-select" },
